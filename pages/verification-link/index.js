            ...
            <form className=" ">
                ...
                <div className="flex flex-col md:flex-row  justify-between md:items-center">
                  <div className="  w-full mt-3">
                    <input
                      ...
                      type="text"
                      placeholder="We've sent a verification link to johndoe@gmail.com"
                      defaultValue=""
                      className="w-full rounded-[18px] py-6 pl-[30px] bg-[#ffffff]/[0.12]"
                    />
                  </div>
                </div>
              </div>
              <div className="mt-[10.5px]">
                <Link href="/forgot-password">
                  <p className="font-nunito font-light text-sm text-[#FFFFFF]/[64%] text-right underline">
                   Change email
                  </p>
                </Link>
              </div>
